  ...
  <div class="product-card" @click="handleCardClick">
    ...
    <div class="card-header">
      <div class="image-container">
        <img 
          :src="product.image || '/img/articles/product-3.jpg'" 
          :alt="product.title"
          class="product-image"
          loading="lazy"
          @error="onImageError"
    ...
    <div class="card-body">
      <!-- Category -->
      <div class="product-category">{{ product.category || 'Thiết bị' }}</div>
      ...
      <div class="rating-section">
        ...
        <span class="rating-text">{{ product.rating || '0.0' }} ({{ product.reviews || 0 }} đánh giá)</span>
      </div>
