  ...
  <section class="product-grid-section">
    <div class="container">
      ...
      <div v-if="!hideHeader" class="section-header">
        ...
        <!-- Navigation Tabs -->
        <div v-if="!hideCategories" class="category-tabs">
          <button 
      ...
      <!-- Products Grid -->
      <div v-if="filteredProducts && filteredProducts.length" class="products-grid" :class="{ 'compact': compact }">
        <ProductCard 
      ...
      <!-- Load More -->
      <div v-if="!hideLoadMore" class="load-more-section">
