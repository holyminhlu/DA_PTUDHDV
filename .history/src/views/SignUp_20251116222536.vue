        ...
        <form @submit.prevent="handleSubmit" novalidate>
          ...
          <div class="form-row">
            <label class="checkbox-row">
              ...
              <span>Tôi đồng ý với <a style="color: 'blue'" href="#">Điều khoản sử dụng</a> và <a href="#">Chính sách bảo mật</a></span>
            </label>
          ...
          <div class="form-row actions">
            ...
            <button type="button" class="btn ghost" @click="goToLogin">Đã có tài khoản? Đăng nhập</button>
          </div>
